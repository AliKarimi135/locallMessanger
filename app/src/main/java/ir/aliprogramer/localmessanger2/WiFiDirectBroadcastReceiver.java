...
import ir.aliprogramer.localmessanger2.model.User;

public class WiFiDirectBroadcastReceiver extends BroadcastReceiver {
    public static final String EXTRA_MESSAGE = "MESSAGE";
    private static final String TAG2 = "WiFiDirectBR";
        ...
        if (WifiP2pManager.WIFI_P2P_STATE_CHANGED_ACTION.equals(action)) {
            ...
            if (WifiP2pManager.WIFI_P2P_STATE_CHANGED_ACTION.equals(action)) {
                ...
                if (state == WifiP2pManager.WIFI_P2P_STATE_ENABLED) {
                    ...
                    Toast.makeText(mActivity,"وایفا  فعال نیست",Toast.LENGTH_SHORT).show();
                }
            }
            ...
            NetworkInfo netwinfo = intent.getParcelableExtra(WifiP2pManager.EXTRA_NETWORK_INFO);
